export const basic = {
  ...
  asideExpandCollapse: 'info',
  asideMenuItem: 'hover:bg-gray-600/50',
...
export const white = {
  ...
  asideMenuItemActiveBg: 'text-black',
...
export const slate = {
  ...
  asideMenuItemActive: 'font-bold text-white',
  asideMenuItemActiveBg: 'bg-slate-600/30',
  asideMenuItemInactive: 'text-slate-300',
  asideSubmenuList: 'bg-slate-700 bg-opacity-50',
  navBarItemLabel: 'text-black',
...
export const zinc = {
  ...
  asideMenuItemActive: 'font-bold text-white',
  asideMenuItemActiveBg: 'bg-zinc-600/30',
  asideMenuItemInactive: 'text-zinc-300',
  asideSubmenuList: 'bg-zinc-700 bg-opacity-50',
  navBarItemLabel: 'text-black',
...
export const neutral = {
  ...
  asideMenuItemActive: 'font-bold text-white',
  asideMenuItemActiveBg: 'bg-neutral-600/30',
  asideMenuItemInactive: 'text-neutral-300',
  asideSubmenuList: 'bg-neutral-700 bg-opacity-50',
  navBarItemLabel: 'text-black',
...
export const stone = {
  ...
  asideMenuItemActive: 'font-bold text-white',
  asideMenuItemActiveBg: 'bg-stone-600/30',
  asideMenuItemInactive: 'text-stone-300',
  asideSubmenuList: 'bg-stone-700 bg-opacity-50',
  navBarItemLabel: 'text-black',
...
export const emerald = {
  ...
  asideExpandCollapse: 'contrast',
  asideMenuItem: 'hover:bg-emerald-600/50',
  asideMenuItemActive: 'font-bold text-white',
  asideMenuItemActiveBg: 'bg-emerald-600/30',
  asideMenuItemInactive: 'text-emerald-300',
  asideSubmenuList: 'bg-emerald-700 bg-opacity-50',
  navBarItemLabel: 'text-black',
...
export const teal = {
  ...
  asideMenuItemActive: 'font-bold text-white',
  asideMenuItemActiveBg: 'bg-teal-600/30',
  asideMenuItemInactive: 'text-teal-300',
  asideSubmenuList: 'bg-teal-700 bg-opacity-50',
  navBarItemLabel: 'text-black',
...
export const cyan = {
  ...
  asideMenuItemActive: 'font-bold text-white',
  asideMenuItemActiveBg: 'bg-cyan-600/30',
  asideMenuItemInactive: 'text-cyan-300',
  asideSubmenuList: 'bg-cyan-700 bg-opacity-50',
  navBarItemLabel: 'text-black',
...
export const sky = {
  ...
  asideMenuItemActive: 'font-bold text-white',
  asideMenuItemActiveBg: 'bg-sky-600/30',
  asideMenuItemInactive: 'text-sky-300',
  asideSubmenuList: 'bg-sky-700 bg-opacity-50',
  navBarItemLabel: 'text-black',
...
export const blue = {
  ...
  asideMenuItemActive: 'font-bold text-white',
  asideMenuItemActiveBg: 'bg-blue-600/30',
  asideMenuItemInactive: 'text-blue-300',
  asideSubmenuList: 'bg-blue-700 bg-opacity-50',
  navBarItemLabel: 'text-black',
  navBarItemLabelHover: 'hover:text-blue-500',
  navBarItemLabelActiveColor: 'text-blue-600',
...
export const indigo = {
  ...
  asideMenuItemActive: 'font-bold text-white',
  asideMenuItemActiveBg: 'bg-indigo-600/30',
  asideMenuItemInactive: 'text-indigo-300',
  asideSubmenuList: 'bg-indigo-700 bg-opacity-50',
  navBarItemLabel: 'text-black',
...
export const violet = {
  ...
  asideMenuItemActive: 'font-bold text-white',
  asideMenuItemActiveBg: 'bg-violet-600/30',
  asideMenuItemInactive: 'text-violet-300',
  asideSubmenuList: 'bg-violet-700 bg-opacity-50',
  navBarItemLabel: 'text-black',
...
export const purple = {
  ...
  asideMenuItemActive: 'font-bold text-white',
  asideMenuItemActiveBg: 'bg-purple-600/30',
  asideMenuItemInactive: 'text-purple-300',
  asideSubmenuList: 'bg-purple-700 bg-opacity-50',
  navBarItemLabel: 'text-black',
...
export const fuchsia = {
  ...
  asideMenuItemActive: 'font-bold text-white',
  asideMenuItemActiveBg: 'bg-fuchsia-600/30',
  asideMenuItemInactive: 'text-fuchsia-300',
  asideSubmenuList: 'bg-fuchsia-700 bg-opacity-50',
  navBarItemLabel: 'text-black',
...
export const pink = {
  ...
  asideMenuItemActive: 'font-bold text-white',
  asideMenuItemActiveBg: 'bg-pink-600/30',
  asideMenuItemInactive: 'text-pink-300',
  asideSubmenuList: 'bg-pink-700 bg-opacity-50',
  navBarItemLabel: 'text-black',
...
export const rose = {
  ...
  asideMenuItemActive: 'font-bold text-white',
  asideMenuItemActiveBg: 'bg-rose-600/30',
  asideMenuItemInactive: 'text-rose-300',
  asideSubmenuList: 'bg-rose-700 bg-opacity-50',
  navBarItemLabel: 'text-black',
